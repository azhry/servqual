...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2018 at 02:07 PM
...
CREATE TABLE `pelamar` (
  ...
  `asal_perguruan_tinggi` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `pelamar` (`id_pelamar`, `username`, `password`, `nama`, `alamat`, `tempat_lahir`, `tgl_lahir`, `no_hp`, `email`, `jk`, `jurusan`, `ipk`, `pendidikan_terakhir`, `asal_perguruan_tinggi`) VALUES
(1, '', '', 'Azhary Arliansyah', 'Bougenville', 'Palembang', '1996-08-05', '0812345', 'arliansyah_azhary@yahoo.com', 'Laki-laki', '', 0, '', ''),
(2, '', '', 'Test', 'sadsf', 'asdas', '0000-00-00', '4534534', 'arliansyah_azhary@yahoo.com', 'Laki-laki', '', 0, '', ''),
(3, '', '', 'Test 2', 'asdasd', 'asdass', '0000-00-00', 'sdf', 'fdsf', 'Laki-laki', '', 0, '', ''),
(4, 'pelamar', '827ccb0eea8a706c4c34a16891f84e7b', 'Ayu Lestari', 'hahah', 'Lahat', '1998-08-10', '71718919', 'lala@yeye.com', 'perempuan', 'aaa', 3.68, 'SMA', 'aa');
