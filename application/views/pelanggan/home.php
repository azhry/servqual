<!-- Slide1 -->
    <section class="slide1">
        <div class="wrap-slick1">
            <div class="slick1">
                <div class="item-slick1 item1-slick1" style="background-image: url(<?= base_url('assets/usertemplate/') ?>images/master-slide-02.jpg);">
                ...
                <div class="item-slick1 item2-slick1" style="background-image: url(<?= base_url('assets/usertemplate/') ?>images/master-slide-03.jpg);">
                    <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
                ...
                <div class="item-slick1 item3-slick1" style="background-image: url(<?= base_url('assets/usertemplate/') ?>images/master-slide-04.jpg);">
                    <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
      ...
      <div class="row">
        <div class="col-sm-10 col-md-8 col-lg-6 m-l-r-auto p-t-15 p-b-15">
          <div class="hov-img-zoom pos-relative">
            <img src="<?= base_url('assets/usertemplate/') ?>images/banner-08.jpg" alt="IMG-BANNER">
        ...
        <div class="col-sm-10 col-md-8 col-lg-6 m-l-r-auto p-t-15 p-b-15">
          <div class="bgwhite hov-img-zoom pos-relative p-b-20per-ssm">
            <img src="<?= base_url('assets/usertemplate/') ?>images/shop-item-09.jpg" alt="IMG-BANNER">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-10 col-md-4 p-b-30 m-l-r-auto">
          ...
          <div class="block3">
            <a href="blog-detail.html" class="block3-img dis-block hov-img-zoom">
              <img src="<?= base_url('assets/usertemplate/') ?>images/blog-01.jpg" alt="IMG-BLOG">
            </a>
        ...
        <div class="col-sm-10 col-md-4 p-b-30 m-l-r-auto">
          ...
          <div class="block3">
            <a href="blog-detail.html" class="block3-img dis-block hov-img-zoom">
              <img src="<?= base_url('assets/usertemplate/') ?>images/blog-02.jpg" alt="IMG-BLOG">
            </a>
        ...
        <div class="col-sm-10 col-md-4 p-b-30 m-l-r-auto">
          ...
          <div class="block3">
            <a href="blog-detail.html" class="block3-img dis-block hov-img-zoom">
              <img src="<?= base_url('assets/usertemplate/') ?>images/blog-03.jpg" alt="IMG-BLOG">
            </a>
  ...
  <section class="instagram p-t-20">
    ...
    <div class="flex-w">
      ...
      <div class="block4 wrap-pic-w">
        <img src="<?= base_url('assets/usertemplate/') ?>images/gallery-03.jpg" alt="IMG-INSTAGRAM">
      ...
      <!-- Block4 -->
      <div class="block4 wrap-pic-w">
        <img src="<?= base_url('assets/usertemplate/') ?>images/gallery-07.jpg" alt="IMG-INSTAGRAM">
      ...
      <!-- Block4 -->
      <div class="block4 wrap-pic-w">
        <img src="<?= base_url('assets/usertemplate/') ?>images/gallery-09.jpg" alt="IMG-INSTAGRAM">
      ...
      <!-- Block4 -->
      <div class="block4 wrap-pic-w">
        <img src="<?= base_url('assets/usertemplate/') ?>images/gallery-13.jpg" alt="IMG-INSTAGRAM">
      ...
      <!-- Block4 -->
      <div class="block4 wrap-pic-w">
        <img src="<?= base_url('assets/usertemplate/') ?>images/gallery-15.jpg" alt="IMG-INSTAGRAM">
