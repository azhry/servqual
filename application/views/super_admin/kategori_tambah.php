          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3 class="page-header">Tambah Kategori</h3>
              </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                      ...
                      <li><i class="fa fa-book"></i><a href="<?= base_url('super_admin/kategori') ?>"> Data Kategori</a></li>
                  ...
                  <div class="x_content">
                        <div class="row">
                            <div class="col-md-offset-1 col-md-10 col-sm-10 col-xs-10">
                                ...
                                <?= form_open('super_admin/tambah-kategori', ['id' => 'form']) ?>
