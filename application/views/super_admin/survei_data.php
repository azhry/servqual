            ...
            <div class="page-title">
              <div class="title_left">
                <h3 class="page-header">Daftar survei
                  <a href="<?= base_url('super_admin/tambah_survei') ?>" class="btn btn-success"><i class="fa fa-plus"></i></a>
                </h3>
              </div>
            </div>
                        ...
                        <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                          <a href="<?= base_url('super_admin/edit_survei/' . $row->id_jawaban_pengguna) ?>" class="btn btn-info"><i class="fa fa-pencil"></i> Edit</a>
...
<script type="text/javascript">
  ...
  function delete_data(id_pengguna) {
    $.ajax({
        url: '<?= base_url('super_admin/survei') ?>',
        type: 'POST',
        data: {
            delete: true,
        ...
        success: function(response) {
            window.location = '<?= base_url('super_admin/survei') ?>';
        }
    });
  }
