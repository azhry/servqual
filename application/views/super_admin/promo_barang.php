          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3 class="page-header">Tambah Promo Barang</h3>
              </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                      ...
                      <li class="active"><i class="fa fa-plus"></i> Promo Barang</li>                    
                    </ol>
                </div>
            </div>
                  ...
                  <div class="x_content">
                        <div class="row">
                            <div class="col-md-offset-1 col-md-10 col-sm-10 col-xs-10">
                                ...
                                <?= form_open_multipart('super-admin/tambah-promo', ['id' => 'form']) ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="tinymce" class="form-control" name="deskripsi"></textarea>
                                </div>
                                ...
                                <div>
                                    <input type="submit" onclick="submit_form();" name="submit" value="Simpan" class="btn btn-success">
                                </div>
