            ...
            <div class="page-title">
              <div class="title_left">
                <h3 class="page-header">Daftar Pemesanan
                  <!-- <a href="<?= base_url('super_admin/tambah_pemesanan') ?>" class="btn btn-success"><i class="fa fa-plus"></i></a> -->
                </h3>
              </div>
            </div>
...
<script type="text/javascript">
  ...
  function delete_data(id_pemesanan) {
    $.ajax({
        url: '<?= base_url('super_admin/pemesanan') ?>',
        type: 'POST',
        data: {
            delete: true,
        ...
        success: function(response) {
            window.location = '<?= base_url('super_admin/pemesanan') ?>';
        }
    });
  }
