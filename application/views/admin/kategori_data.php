            ...
            <div class="page-title">
              <div class="title_left">
                <h3 class="page-header">Daftar Kategori
                  <a href="<?= base_url('admin/tambah_kategori') ?>" class="btn btn-success"><i class="fa fa-plus"></i></a>
                </h3>
              </div>
            </div>
                        ...
                        <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                          <a href="<?= base_url('admin/edit_kategori/' . $row->id_kategori_barang) ?>" class="btn btn-info"><i class="fa fa-pencil"></i> Edit</a>
