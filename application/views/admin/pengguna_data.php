            ...
            <div class="page-title">
              <div class="title_left">
                <h3 class="page-header">Daftar pengguna
                  <a href="<?= base_url('admin/tambah_pengguna') ?>" class="btn btn-success"><i class="fa fa-plus"></i></a>
                </h3>
              </div>
            </div>
                        ...
                        <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                          <a href="<?= base_url('admin/detail_pengguna/' . $row->id_pengguna) ?>" class="btn btn-success"><i class="fa fa-eye"></i> Detail</a>
                                          <a href="<?= base_url('admin/edit_pengguna/' . $row->id_pengguna) ?>" class="btn btn-info"><i class="fa fa-pencil"></i> Edit</a>
