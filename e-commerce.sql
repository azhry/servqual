...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 14, 2018 at 06:38 AM
...
INSERT INTO `barang` (`kode_barang`, `id_kategori_barang`, `nama`, `deskripsi`, `harga`, `stok`, `status`, `jenis`) VALUES
('0AVRWQCT', 2, 'Testing', '', 2000, 9, '1', 'Reguler'),
('1', 1, 'Softshell Warna Warni Gambar Hellokitty And Doraemon 3d* ', 'J5\r\nJ1Ace\r\nJ2Prime\r\nG530/Grand Prime *Xiaomi/Redmi*\r\nRedmi 4X\r\nRedmi 4A\r\nRedmi Note 5Pro\r\nRedmi Note 4X\r\nRedmi 3pro *OPPO*\r\nF7 New\r\nF5\r\nA59/F1s\r\nA39/A57\r\nA33/Neo 7\r\nA37/Neo 9 *VIVO*\r\nVivo V9 New\r\nVivo Y71 New\r\nVivo y65', 40000, 9, '1', 'Reguler'),
('10', 1, 'Case Animal + tg', 'Type :\r\n- Samsung J2prime\r\n- Iphone 5\r\n- Oppo A37\r\n- Oppo F1s\r\n- Oppo A83\r\n- Oppo F5\r\n- Oppo F7\r\n- Vivo V7+\r\n- Vivo V9\r\n- Vivo Y65\r\n- Xiaomi redmi 4x\r\n- Xiaomi redmi note 5a\r\n', 60000, 10, '1', 'Reguler'),
('11', 4, 'Serutan Jagung ', '', 30000, 9, '1', 'Reguler'),
('12', 4, 'Tatakan Pembuat Kue Maksuba dll ', '', 5000, 10, '1', 'Reguler'),
('13', 4, 'Saringan Teh Jumbo ', '', 20000, 10, '1', 'Reguler'),
('14', 4, 'Cetakan Cendol ', '', 20000, 10, '1', 'Reguler'),
('15', 4, 'Garpu / Sendok Motif Jagung ', 'isi 12 pcs', 15000, 10, '1', 'Reguler'),
...
('18', 4, 'Teflon Mini Karakter ', '', 25000, 10, '1', 'Reguler'),
('19', 4, 'Cake Decoration 8 in 1 ', '', 30000, 10, '1', 'Reguler'),
...
('20', 4, 'Apron - Celemek anti air', '', 20000, 10, '1', 'Reguler'),
('21', 2, 'Jam Fashion ', '', 30000, 10, '1', 'Reguler'),
('22', 2, 'Jam Fashion ', '', 30000, 10, '1', 'Reguler'),
('23', 2, 'Tas pesta premium', '', 240000, 10, '1', 'Reguler'),
('24', 2, 'Tas pesta 20319', '', 190000, 10, '1', 'Reguler'),
('25', 2, 'Tas pesta c272', '', 125000, 10, '1', 'Reguler'),
('26', 2, 'Tas pesta', '', 125000, 10, '1', 'Reguler'),
('27', 2, 'Tas selempang', '', 60000, 10, '1', 'Reguler'),
('28', 2, 'Tas pesta glitter', '', 95000, 10, '0', 'Reguler'),
('29', 2, 'Tas selempang cewek', '', 90000, 10, '0', 'Reguler'),
...
('30', 2, 'Dompet cewek bling2', '', 40000, 10, '0', 'Reguler'),
('31', 2, 'Tas korea square', '', 85000, 10, '0', 'Reguler'),
('32', 2, 'Tas wanita', '', 65000, 10, '0', 'Reguler'),
('33', 2, 'Somlloh pendek Dompet purse wallet fashion korean style', '', 50000, 10, '0', 'Reguler'),
('34', 2, 'Keranjang multifungsi ', '', 35000, 10, '0', 'Reguler'),
('35', 3, 'Celengan Kaleng Karakter ', '', 15000, 10, '0', 'Reguler'),
('36', 3, 'Robocar', '', 60000, 10, '0', 'Reguler'),
('366EM1IO', 4, 'asdads', '<p>sadas</p>', 20000, 100, '1', 'Reguler'),
('37', 3, 'Boneka Tayo ', 'Boneka tayo size L\r\nUkuran 28 cm x 25 Cm\r\n', 50000, 10, '0', 'Reguler'),
('38', 3, 'Uno Stacko ', 'Mainan keluarga terdiri dari 45 balok yang disusun menjadi tower lalu balok-baloknya dilepas satu persatu oleh pemain tanpa menyentuh tower. Pemain yg merobohkan tower adalah yg kalah.', 85000, 10, '0', 'Reguler'),
('39', 3, 'Papan Tulis Anak Karakter + Bonus Spidol (Lengkap Penghapus)', 'Ukuran papan Lebar x Tinggi (cm) = 30 x 20 cm', 25000, 10, '0', 'Reguler'),
('3WX3JO42', 1, 'Testing 2', '<p>h3h3</p>', 1000, 10, '1', 'Reguler'),
('4', 1, 'Charger Asus Original ', 'Spesifikasi :\r\n* Input : 100-240VAC , 50/60Hz , 0.5A\r\n* Output : 5V / 2000mA\r\n', 110000, 10, '1', 'Reguler'),
('40', 3, 'Mobil mainan berbahan besi isi 6 pcs dgn variasi warna yg berbeda', '', 25000, 10, '0', 'Reguler'),
('41', 3, 'Mainan Gelembung Sabun ', '', 40000, 10, '0', 'Reguler'),
('42', 3, 'Mainan Make Up Anak anak', '', 40000, 10, '0', 'Reguler'),
('43', 3, 'Mini Market Kasir ', '', 195000, 10, '0', 'Reguler'),
('44', 3, 'Boneka Tom Cat Besar ', '', 170000, 10, '0', 'Reguler'),
...
('46', 5, 'Beauty blender Sponge', '', 5000, 10, '0', 'Reguler'),
('47', 5, 'Pemencet Jerawat ', '', 5000, 10, '0', 'Reguler'),
('48', 5, 'Kuas make up naked ', '', 75000, 10, '0', 'Reguler'),
('49', 5, 'Gunting kuku Karakter ', '', 10000, 10, '0', 'Reguler'),
('5', 1, 'Charger Xiaomi Original (Kepala Indonesia) ', 'Spesifikasi :\r\n* MDY-03-AF\r\n* Input : 100-240VAC , 50/60Hz , 0.5A\r\n* Output : 5V / 2000mA\r\n', 110000, 10, '1', 'Reguler'),
('50', 5, 'Eyebrow Template Alis - Cetakan Alis Mata', '', 10000, 10, '0', 'Reguler'),
('51', 5, 'Sisir Jumbo Anti Rontok ', '', 15000, 10, '0', 'Reguler'),
('52', 5, 'Cermin Led ', '', 40000, 10, '0', 'Reguler'),
('53', 5, 'Mangkok masker set', '', 25000, 10, '0', 'Reguler'),
('54', 5, 'Penjepit Bulu Mata Galenco New York ', '', 10000, 10, '0', 'Reguler'),
('55', 4, 'Mixer Garlic ', 'MIXER GARLIC ( PAKING SEGEL )\r\nBUKAN PAKING OPP / PLASTIK apalagi yang tidak pakai paking, hanya barang saja, beda kualitas, beda harga \r\nAlat press untuk menghaluskan dan mencacah bawang putih, jahe, bumbu dapur lainnya. Bisa digunakan juga untuk memudahkan mengupas kulit bawang putih.\r\n', 15000, 10, '0', 'Reguler'),
('56', 2, 'Tas pesta 0331', '', 115000, 10, '0', 'Reguler'),
('57', 1, 'hardcase', '<p>aa</p>', 30000, 50, '1', 'Reguler'),
('5FE6VJXN', 2, 'Azhary Arliansyah', '<p>as</p>', 1000, 100, '1', 'Reguler'),
('6', 1, 'Man case + Tg', 'Type\r\n- Oppo A83\r\n- Oppo F3\r\n- Oppo F5\r\n- Oppo A71\r\n- Oppo A37\r\n- Oppo A57\r\n- Xiaomi redmi note 5a\r\n- Xiaomi redmi note 4\r\n- Xiaomi 5plus\r\n- Samsung J2prime\r\n- Vivo V9\r\n', 60000, 10, '1', 'Reguler'),
('7', 1, 'Softcase Fuze Glass \"Pattern Design\" :', '~OPPO F7\r\n~OPPO F5\r\n~OPPO A83\r\n~OPPO A71\r\n~OPPO NEO 9\r\n~OPPO A57\r\n~REDMI 5\r\n~REDMI 5+\r\n~REDMI 5A\r\n~REDMI NOTE 5A\r\n~REDMI 5X /A1\r\n~REDMI NOTE 4X\r\n~VIVO V9\r\n~VIVO V7\r\n~ J2 PRO\r\n~J2 PRIME\r\n~ J7+\r\n~IPHONE 5G\r\n~IPHONE 6G\r\n~IPHONE 6G+\r\n', 40000, 10, '1', 'Reguler'),
('7VL817M5', 2, 'aaabb', '<p>abcd</p>', 100000, 100, '1', 'Reguler'),
...
('PTU861LL', 1, 'Cuba', '<p>aaa bbb</p>', 123455, 10, '0', 'Reguler'),
('Z4S2HTK6', 3, 'Azhary Arliansyah', '<p>asdsad</p>', 2000, 100, '1', 'Promo');
...
--
ALTER TABLE `jawaban_pengguna`
  MODIFY `id_jawaban_pengguna` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
